...
object ex4 {
    def main(args: Array[String]) {
        ...
        val seq1 = Apply(player1Card, player1Bet1, player2Bet,
            (card1: Int, bet11: Boolean, bet2: Boolean) =>
                card1 == 5 && bet11 && !bet2)

        val seq2 = Apply(player2Card, player1Bet1, player2Bet, player1Bet2,
            (card2: Int, bet11: Boolean, bet2: Boolean, bet12: Boolean) =>
                (card2 == 5 || card2 == 4) && !bet11 && bet2 && !bet12)

        val seq3 = Apply(player1Card, player2Card,
            (card1: Int, card2: Int) =>
                card1 == 5 || card2 == 5 || card1 == 4 || card1 == 3 || card1 == 2 || card1 == 1)

        println("Probability of seq1 to be true: " + VariableElimination.probability(seq1, true))
        println("Probability of seq1 to be false: " + VariableElimination.probability(seq1, false))
        println("Probability of seq2 to be true: " + VariableElimination.probability(seq2, true))
        println("Probability of seq3 to be true: " + VariableElimination.probability(seq3, true))
